...
public class PIDLineFollowing4 {
	...
	public void move() {
		...
		while(true) {
			...
			leftMotor.setPower(20.0 - steeringValue);
			//leftMotor.setPower(new Double(20.0 - correction.intValue()));
			leftMotor.forward();


			rightMotor.setPower(20.0 + steeringValue);
			//rightMotor.setPower(new Double(20.0 + correction.intValue()));
			rightMotor.forward();
